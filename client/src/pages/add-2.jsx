...
const AddQuotation = () => {
  ...
  const handleSaveInvoice = () => {
    ...
    if (form.createdDate && form.expiryDate && form.expiryDate < form.createdDate) {
              ...
              <>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                  ...
                  <div className="hidden md:grid grid-cols-12 bg-gray-50 text-gray-600 text-xs font-semibold uppercase px-6 py-3 border-b border-gray-200">
                    ...
                    <div className="col-span-1 px-2 text-right">Margin Percentage</div>
